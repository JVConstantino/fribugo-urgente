-- Drop and recreate tables with properly quoted camelCase column names
-- This ensures PostgreSQL preserves the case sensitivity
...
-- Recreate with proper quoted identifiers
...
CREATE INDEX ads_startsAt_idx ON ads("startsAt");
CREATE INDEX ads_endsAt_idx ON ads("endsAt");
CREATE INDEX popups_startsAt_idx ON popups("startsAt");
CREATE INDEX popups_endsAt_idx ON popups("endsAt");
