...
async function createPageViewsTable() {
  try {
    ...
    // Para executar SQL bruto no Supabase, precisamos usar a REST API diretamente
    // A client SDK não tem suporte direto para exec() sem uma função RPC
    // Vamos fazer via HTTP POST para a API RPC
